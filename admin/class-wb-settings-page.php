		...
		<table class="form-table">
			...
			<tr>
				...
				<td>
					...
					<label><input type="checkbox" name="delete_data_on_uninstall" value="1" <?php checked( $s['delete_data_on_uninstall'], 1 ); ?>> <?php esc_html_e( 'Delete all data on uninstall', WB_TEXT_DOMAIN ); ?></label><br>
					<label><input type="radio" name="retention_action" value="delete" <?php checked( $s['retention_action'], 'delete' ); ?>> <?php esc_html_e( 'Delete expired requests', WB_TEXT_DOMAIN ); ?></label><br>
					<label><input type="radio" name="retention_action" value="anonymize" <?php checked( $s['retention_action'], 'anonymize' ); ?>> <?php esc_html_e( 'Anonymize expired requests', WB_TEXT_DOMAIN ); ?></label>
				</td>
			</tr>
		</table>
